	...
	do
	  {
		...
		if(splitMessage[2] == null || !TypeMessage.isGoodType(splitMessage[2]))
		  {
		    System.out.println("Message \"" + message + "\" uncorrectly formatted");
		    // System.exit(0);
		  }
...
class Friend2Task extends TimerTask {
  ...
  Friend2Task(HashMap<String, Timer> hm, HashMap<String, Timer> hm2, String friendName) {
    this.hm = hm;
    this.hm2 = hm2;
    this.friendName = friendName;    
  }
